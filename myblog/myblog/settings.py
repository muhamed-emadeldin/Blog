...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "blog_templeates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
BLOG_CDN            = os.path.join(os.path.dirname(BASE_DIR), "blog_CDN")
STATICFILES_DIRS    = [os.path.join(BASE_DIR, "blog_static")]
STATIC_ROOT         = os.path.join(BLOG_CDN, "static")
MEDIA_ROOT          = os.path.join(BLOG_CDN, "media")
MEDIA_URL           = "/media/"
STATIC_URL          = '/static/'
